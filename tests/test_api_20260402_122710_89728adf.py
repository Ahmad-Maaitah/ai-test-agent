...
Execution ID: 20260402_122710_89728adf
URL: https://api.opensooq.com/vertical/forms/v1/add-post/normal/init_CategoryStep/1166?expand=remaining_edit_counter,media,post.overLimitType,post.isOverLimit&cMedium=web_open&cName=direct_web_open&cSource=opensooq&abBucket=3
Method: POST
"""
...
API_CONFIG = {
    ...
    'data': 'undefined=1&draftId=6cfb0ad3-c7da-4d73-82ab-29af19f24bbf&workflowId=1166&currentStep=init_CategoryStep&categoriesMain=1775&time_spent_ms=313206',
    'verify': True,
    'timeout': 30
}
