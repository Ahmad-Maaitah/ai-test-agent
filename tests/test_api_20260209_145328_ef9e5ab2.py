...
Execution ID: 20260209_145328_ef9e5ab2
...
API_CONFIG = {
    'method': 'GET',
    'url': 'https://api.opensooq.com/v2.1/cities?expand=neighborhoods',
    'headers': {'source': 'ios', 'x-access-token': 'a9d85bf9942cf90b64793dfe5aad7564dfc104b7', 'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdDAiOjE3NDcwNTM1NDUsImF1ZCI6ImRlc2t0b3AiLCJzdWIiOjE0NDQyMDY0LCJybmQiOiIzNzEyMTMxNSIsImV4cCI6MTc0NzI5NjEyM30.8CxffCKPHffoLZtvJp1SAoWcvPFcYzBH5LAPLt205aY'},
    'data': None,
    'verify': True,
    'timeout': 30
}
