...
Execution ID: 20260215_172302_98165826
...
API_CONFIG = {
    ...
    'data': 'draftId=d1eb9b69-a782-4b53-8a6a-c1135de23a23&undefined=1&hasCps=1&cityField=59&postMedia=0&postVideo=0&workflowId=401100&currentStep=post_reelStepIdentifier&neighborhood=6743&categoriesSub=7107&time_spent_ms=135783&categoriesMain=7105&payloadPassCps={&stepIdentifier=post_previewStep&cpDeliveryService=1&post_phone[phone]=0785569342&listingTitleIdentifier=asdh asdjahshd asdjhahjsdhas dashdjhad&listingDescriptionIdentifier=asdh asdjahshd asdjhahjsdhas dashdjhad&price_field[min]=30&price_field[max]=&price_field[unit]=10&cName=direct_web_open&phone=0785569342&cMedium=web_open&cSource=opensooq',
    'verify': True,
    'timeout': 30
}
