...
Execution ID: 20260209_141140_c95227c3
URL: https://api.opensooq.com/v2.1/configurations?expand=ticket
Method: GET
"""
...
API_CONFIG = {
    'method': 'GET',
    'url': 'https://api.opensooq.com/v2.1/configurations?expand=ticket',
    'headers': {'country': 'jo', 'source': 'ios', 'Authorization': 'Basic MDc4ODY3OTQ1NTowOTg3NjU0MzI='},
    'data': None,
    'verify': True,
    'timeout': 30
}
