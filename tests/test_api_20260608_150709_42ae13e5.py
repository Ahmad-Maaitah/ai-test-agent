...
Execution ID: 20260608_150709_42ae13e5
...
API_CONFIG = {
    'method': 'GET',
    'url': 'https://opensooq.com/api/home/v2/full?source=opensooq&medium=app_open&campaign=direct_app_open&abBucket=3',
    'headers': {'release-version': '12.3', 'ConnectionType': 'WiFi', 'source': 'ios', 'Accept-Language': 'ar', 'country': 'jo', 'Cookie': 'NEXT_LOCALE=ar; default_currency=JOD; ecountry=jo; session=%7B%22id%22%3A%2212b504375ea2-43c797585a2e-61fe-461a-8e2b-a54969c1c3b6%22%2C%22startedAt%22%3A1780498762137%7D; source=desktop', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36'},
    'data': None,
    'verify': True,
    'timeout': 30
}
