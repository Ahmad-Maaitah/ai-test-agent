...
Execution ID: 20260406_101941_e69f72a7
URL: https://api.opensooq.com/vertical/forms/v1/add-post/normal/init_CategoryStep/1178?expand=remaining_edit_counter,media,post.overLimitType,post.isOverLimit&cMedium=web_open&cName=direct_web_open&cSource=opensooq&abBucket=3
Method: POST
"""
...
API_CONFIG = {
    ...
    'data': 'undefined=1&draftId=7e10f30a-64ba-47e0-bc86-7ba029053f01&workflowId=1178&currentStep=init_CategoryStep&categoriesMain=1775&time_spent_ms=313206',
    'verify': True,
    'timeout': 30
}
