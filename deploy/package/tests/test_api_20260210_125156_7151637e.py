...
Execution ID: 20260210_125156_7151637e
URL: https://opensooq.com/api//account/my-account/overview/v1?source=opensooq&medium=app_open&campaign=direct_app_open
Method: GET
"""
...
API_CONFIG = {
    'method': 'GET',
    'url': 'https://opensooq.com/api//account/my-account/overview/v1?source=opensooq&medium=app_open&campaign=direct_app_open',
    'headers': {'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdDAiOjE3NzA1OTQwMDcsImF1ZCI6ImRlc2t0b3AiLCJzdWIiOjgwNjE0MDAxLCJybmQiOiIxMjQxMjkxMCIsImV4cCI6MTc3MDcwODIzMX0.G8lcY5TWWVGaySPZoR_8rLmAlBttv9wMIrxaikJncxo', 'Accept-Language': 'ar', 'Device-Language': 'ar', 'source': 'web', 'country': 'jo'},
    'data': None,
    'verify': True,
    'timeout': 30
}
