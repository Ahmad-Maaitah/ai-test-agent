...
Execution ID: 20260406_101933_d5ed6580
...
API_CONFIG = {
    'method': 'GET',
    'url': 'https://opensooq.com/api//home/v2/full?source=opensooq&medium=app_open&campaign=direct_app_open&abBucket=3',
    'headers': {'release-version': 'pwa-prod-7.2.03-build-2435', 'ConnectionType': 'WiFi', 'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdDAiOjE3NDcwNTM1NDUsImF1ZCI6ImRlc2t0b3AiLCJzdWIiOjE0NDQyMDY0LCJybmQiOiIzNzEyMTMxNSIsImV4cCI6MTc0NzI5NjEyM30.8CxffCKPHffoLZtvJp1SAoWcvPFcYzBH5LAPLt205aY', 'source': 'ios', 'Accept-Language': 'ar', 'country': 'jo'},
    'data': None,
    'verify': True,
    'timeout': 30
}
